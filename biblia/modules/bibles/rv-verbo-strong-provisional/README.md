...
Estado al 10 de agosto de 2026: 31.097 registros de versículos, texto idéntico a Biblia Verbo, 253.792 asociaciones y 29.080 versículos etiquetados. Hay 65.037 asociaciones `verified-open`, 7.120 `cross-verified-open` y 181.635 `provisional-reference`. La cobertura sobre los grupos STEPBible es 60,68 %. La auditoría integral de texto, versificación, segmentos, índices y diccionario no registra errores. La revisión editorial debe reemplazar progresivamente las asociaciones provisionales antes de adoptar una licencia abierta definitiva.
