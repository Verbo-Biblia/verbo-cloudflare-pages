...
- Mateo, Marcos, Lucas, Juan, Hechos, Romanos, 1 Corintios, 2 Corintios,
  Gálatas y Efesios quedaron completamente cerrados (2026-08-07): Mateo,
  ...
  versículos; Efesios, 6 capítulos y 155 versículos; todos con validación
  de calidad sobre el libro completo, 0 problemas (sin desajuste de
  conteo vs. RVA1909, sin campos vacíos, sin arcaísmos "vosotros"
...
- Siguiente archivo: `biblia/modules/bibles/rv-verbo/books/PHP.json`.
- Nota de método (aplica a Hechos, Romanos, 1-2 Corintios, Gálatas y
  Efesios, y previsiblemente al resto de epístolas): varios versículos con
  lectura Textus Receptus/RVA1909 sin paralelo en el texto crítico moderno
  ...
  Gálatas 5:19 ("adulterio" en la lista de obras de la carne); Efesios
  5:30 ("de su carne y de sus huesos"). También: "caridad" (RVA1909) se
  modernizó a "amor" en 1 Corintios 13 y Gálatas 5:6, 5:22, consistente
  con el resto del NT ya publicado. Los colofones finales de cada epístola
  (quién la escribió, desde dónde se envió) se conservan como parte del
  último versículo, igual que en Romanos, 1-2 Corintios, Gálatas y
  Efesios.
